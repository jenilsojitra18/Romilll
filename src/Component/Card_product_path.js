...
function Card_product_path() {
  return (
    <div>
       <div className="container-fluid page-header mb-5 p-0 bg-img">
        <div className="container-fluid page-header-inner py-5">
            <div className="container text-center">
                <h1 className="display-3 text-white mb-3 animated slideInDown">Product Name</h1>
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb justify-content-center text-uppercase list-none">
                        ...
                        <SlArrowRight className="text-white fw-bold mt-1" />
                        <li className="breadcrumb-item text-white " aria-current="page">
                        <Link className='mx-auto text-decoration-none text-white text-[18px] px-3' to="/Card_product">    
                        Product Name
                        </Link> 
                        </li>
                    </ol>
...
export default Card_product_path
